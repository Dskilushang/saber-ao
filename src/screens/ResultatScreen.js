...
const getMessage = (pct, lang) => {
  const messages = {
    pt: [
      {
        min: 0.8,
        txt: '🏆 És um verdadeiro filho do país!',
      },
      {
        min: 0.5,
        txt: '👏 Bravo — conheces bem Angola!',
      },
      {
        min: 0.0,
        txt: '💪 Continua a aprender sobre o teu país!',
      },
    ],
    ...
    fr: [
      {
        min: 0.8,
        txt: '🏆 Tu es un vrai fils du pays !',
      },
      {
        min: 0.5,
        txt: "👏 Bravo — tu connais bien l'Angola !",
      },
      {
        min: 0.0,
        txt: '💪 Continue d’apprendre sur ton pays !',
      },
    ],
  };
  ...
  ).find((message) => pct >= message.min)?.txt || '';
};
...
const styles = StyleSheet.create({
  ...
  card: {
    backgroundColor: 'rgba(20,30,65,0.8)',
    width: '100%',
    borderRadius: 20,
    padding: 24,
    alignItems: 'center',
